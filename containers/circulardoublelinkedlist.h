...
// Reutilizacion Node en DLL: CDLL usa DLLNode<T>, el mismo nodo que DoubleLinkedList
template <typename T>
...
// Reutilizacion iterator: CDLLForwardIterator hereda circular_iterator (avance por getNext())
...
// Reutilizacion iterator: CDLLBackwardIterator hereda circular_iterator (avance por getPrev())
template <typename Container>
