...
// Reutilizacion iterator: LinkedListForwardIterator hereda general_iterator
...
// Reutilizacion Node en CLL: LLNode<T> es reutilizado por CircularLinkedList sin crear un nuevo nodo
// Reutilizacion Node en DLL: DLLNode<T> hereda LLNode<T, DLLNode<T>> y agrega m_pPrev
...
protected:
    ...
    // internal_insert virtual: CLL y CDLL llaman a LinkedList::insert() que usa este metodo
...
public:
    ...
    // Reutilizacion iterator: begin/end virtual para que derivadas retornen sus propios iteradores
    ...
    // Reutilizacion operator<<: definido una sola vez; usa m_size para funcionar con listas circulares
    ...
    // Reutilizacion operator>>: definido una sola vez; llama insert() virtual (CLL/DLL/CDLL lo sobreescriben)
