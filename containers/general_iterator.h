...
// Reutilizacion iterator: base para todos los iteradores de lista
...
public:
    ...
    // Reutilizacion iterator: avance por defecto via getNext(); derivadas sobreescriben si necesitan
...
// Reutilizacion iterator: extiende general_iterator para listas circulares con m_pRoot como sentinel
template <typename Container, class IteratorBase>
