...
protected:
    ...
    // BinaryTree: busqueda BST con equivalencia generica
    ...
    // BinaryTree: impresion visual indentada
...
public:
    ...
    // BinaryTree: busqueda con shared_lock
    ...
    // BinaryTree: impresion visual del arbol
